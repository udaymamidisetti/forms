                ...
                <table class="question-table">
                  ...
                  <tfoot>
                    <tr class="total-row">
                      ...
                      <td class="field-cell">
                        <div class="inner">
                          <span class="question-psum-current">0 </span>/ 100{" "}
                        </div>
                      </td>
                    </tr>
                  </tfoot>
