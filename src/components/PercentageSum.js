              ...
              <div className="flex">
                <div className="mr-[5px]">
                  <button
                    ...
                    className="h-[36px] leading-[20px] text-[1(2px] pt-[8px] pb-[8px] pl-[10px] pr-[10px] text-[#3c8dd5]"
                    onClick={onDelete}
                  >
                    Cancel
                  </button>
            ...
            {showFull ? (
              <>
                <div className="flex mt-[20px]">
                  ...
                  <div>
                    <div className="flex items-center gap-[5px]">
                      <select className="border focus:outline-none text-[12px] pl-[6px] pt-[3px] pb-[3px]">
                        <option>Order as entered</option>
                        <option>Randomize Fields</option>
                      </select>
                    </div>
                  </div>
                </div>
