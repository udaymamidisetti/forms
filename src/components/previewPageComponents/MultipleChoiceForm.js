        ...
        <div key={index}>
          <div className="max-w-[900px] m-auto pt-[30px]">
            <div className="flex items-center gap-[10px]">
              ...
              {e.requiredOption ? <span className="text-[red]">*</span> : ""}
              <div
                className="text-[13px]"
            ...
            {e.image === null ? "" : <img src={e.image} alt="image" />}
            <div className={e.choiceLayout === "horizontal" ? "flex" : ""}>
              {e.randomChoice
                ? shuffle(e.options).map((k, index) => (
                    <>
                      <div
