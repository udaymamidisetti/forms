              ...
              <table className="w-[100%] mt-[10px]">
                <thead>
                  <tr class="column-row">
                    ...
                    <td class="column-label" style={{ width: "30px" }}>
                      <div className="text-center text-[14px]">Column 1</div>
                    </td>
                    <td class="column-label" style={{ width: "30px" }}>
                      <div className="text-center text-[14px]">Column 2</div>
                    </td>
                  </tr>
                </thead>
                <tbody>
                  <tr class="field-row first">
                    <td class="row-label" style={{ width: "40%" }}>
                      <div className="text-[14px]">Row 1</div>
                    </td>
                    <td class="field-cell" style={{ width: "30%" }}>
                      <div class="inner">
                        <select
                          class="form-input form-control"
                          name="question[858067][1314482]"
                          id="question_858067_1314482_0"
                          className="border-[1px] border-solid border-[#ccc] h-[34px] w-[100%]"
                        >
                          <option value=""></option>
                    ...
                    <td class="field-cell" style={{ width: "30%" }}>
                      <div class="inner">
                        <select
                          class="form-input form-control"
                          name="question[858067][1314483]"
                          id="question_858067_1314483_1"
                          className="border-[1px] border-solid border-[#ccc] h-[34px] w-[100%]"
                        >
                          <option value=""></option>
                          <option value="1">Option 1</option>
